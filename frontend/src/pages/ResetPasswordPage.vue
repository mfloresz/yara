        ...
        <div class="panel-view">
          ...
          <template v-if="token && validation">
            ...
            <template v-if="!validation.valid">
              <n-alert type="error" title="Enlace no válido">
            ...
            <!-- Enlace válido: elegir contraseña nueva. -->
            <template v-else>
              <div class="how-box">
                <p class="small how-title">
                  <n-icon :component="InformationCircleOutline" /> Restablecer acceso{{ validation.email ? ` para ${validation.email}` : '' }}
                </p>
              ...
              <form class="login-form" @submit.prevent="submit">
                <div>
                  <label class="small muted" for="reset-password">Nueva contraseña</label>
                  <n-input
                    id="reset-password"
                ...
                <div>
                  <label class="small muted" for="reset-confirm">Repetir contraseña</label>
                  <n-input
                    id="reset-confirm"
          ...
          <template v-else>
            <p class="small muted invite-sub">
              Yara es una aplicación privada. Necesitas un enlace de recuperación para cambiar tu contraseña.
            </p>
            <div class="how-box">
              <p class="small how-title">
              ...
              <ol class="small muted how-list">
                <li>Un administrador te envía un enlace de recuperación.</li>
                <li>Pégalo aquí: validamos que no esté vencido ni usado.</li>
                <li>Elige una contraseña nueva.</li>
              </ol>
            </div>
            <form class="login-form" @submit.prevent="submitManualToken">
              <div>
                <label class="small muted" for="reset-link">Enlace o código</label>
                <n-input
                  id="reset-link"
                  v-model:value="manualToken"
                  placeholder="https://…/reset-password/…"
                />
              </div>
              <n-alert v-if="error" type="error" :title="error" />
              <n-button
...
import { NInput, NButton, NAlert, NIcon, useMessage } from "naive-ui";
